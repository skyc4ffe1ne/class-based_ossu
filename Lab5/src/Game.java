...
class ExamplesGame{
  ...
  Circle c_0 = new Circle(p_0,p_0_velocity);
  Circle c_1 = new Circle(p_1,p_1_velocity);
  Circle c_2 = new Circle(p_2,p_2_velocity);
  Circle c_3 = new Circle(p_3,p_3_velocity); 
 ...
 // Test method move 
  boolean testMove(Tester t) {
    return
        t.checkExpect(c_0.move(), new Circle(new MyPosn(105, 100), p_0_velocity))
        &&
        t.checkExpect(c_1.move(), new Circle(new MyPosn(150, 255), p_1_velocity)) 
        &&
        t.checkExpect(c_2.move(), new Circle(new MyPosn(17, 57), p_2_velocity)) 
        &&
        t.checkExpect(c_3.move(), new Circle(new MyPosn(48, 36), p_3_velocity)) 
        ;
  }
  ...
  return
      t.checkExpect(loC_0.moveAll(), 
          new ConsLoCircle(
              new Circle(new MyPosn(105, 100), p_0_velocity),
                new ConsLoCircle(new Circle(new MyPosn(150, 255), p_1_velocity)
                    , emptyList)))
      &&
      t.checkExpect(loC_1.moveAll(), 
          new ConsLoCircle(
              new Circle(new MyPosn(105, 100), p_0_velocity),
                new ConsLoCircle(new Circle(new MyPosn(150, 255), p_1_velocity),
                    new ConsLoCircle(new Circle(new MyPosn(17, 57), p_2_velocity),
                        emptyList))))
      &&
      t.checkExpect(loC_2.moveAll(), 
          new ConsLoCircle(
              new Circle(new MyPosn(105, 100), p_0_velocity),
                new ConsLoCircle(new Circle(new MyPosn(150, 255), p_1_velocity),
                    new ConsLoCircle(new Circle(new MyPosn(17, 57), p_2_velocity),
                        new ConsLoCircle(new Circle(new MyPosn(48, 36), p_3_velocity),
                            emptyList)))))
      ;
  }
